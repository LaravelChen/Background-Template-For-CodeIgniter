...
<?php $this->load->view('editormd/editor_css')?>
<div class="content-wrapper">
    <section class="content-header">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="<?= base_url() . '/admin' ?>"><i class="fa fa-dashboard"></i> 主页</a></li>
                <li class="active"><a href="<?= base_url() . 'admin/articleshow' ?>">内容管理 - 文章</a></li>
            </ol>
        </section>
    </section>
...
<?php $this->load->view('editormd/editor_js')?>
